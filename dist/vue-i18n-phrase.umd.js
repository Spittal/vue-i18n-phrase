(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('commander'), require('chalk'), require('fs'), require('path'), require('vue-i18n-extract'), require('axios'), require('form-data')) :
  typeof define === 'function' && define.amd ? define(['commander', 'chalk', 'fs', 'path', 'vue-i18n-extract', 'axios', 'form-data'], factory) :
  (global = global || self, factory(global.commander, global.chalk, global.fs, global.path, global.VueI18NExtract, global.axios, global.FormData));
}(this, (function (commander, chalk, fs, path, VueI18NExtract, axios, FormData) {
  ...
  VueI18NExtract = VueI18NExtract && Object.prototype.hasOwnProperty.call(VueI18NExtract, 'default') ? VueI18NExtract['default'] : VueI18NExtract;
